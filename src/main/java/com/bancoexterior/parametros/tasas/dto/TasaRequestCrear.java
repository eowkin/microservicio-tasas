...
@Data
public class TasaRequestCrear implements Serializable{
	...
	@Valid
	private TasaDtoRequestCrear tasaDtoRequestCrear;
	
	public TasaRequestCrear() {
		super();
		tasaDtoRequestCrear = new TasaDtoRequestCrear(); 
	}
