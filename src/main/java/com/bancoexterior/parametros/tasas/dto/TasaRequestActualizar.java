...
@Data
public class TasaRequestActualizar implements Serializable{
	...
	@Valid
	private TasaDtoRequestActualizar tasaDtoRequestActualizar;
	
	public TasaRequestActualizar() {
		super();
		tasaDtoRequestActualizar = new TasaDtoRequestActualizar(); 
	}
